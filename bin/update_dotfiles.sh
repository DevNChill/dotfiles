...
# Paths
DOTFILES_DIR="/home/mid3ee/CodeHaven/repos/dotfiles"
...
rsync -av --delete --exclude '.git' "$HOME/CodeHaven/repos/dotfiles/update_dotfiles.sh" "$DOTFILES_DIR/update_dotfiles.sh"
